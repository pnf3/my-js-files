    ...
    function convertRelatedPostsToTable() {
        ...
        relatedItems.forEach((item) => {
            ...
            let rowHTML = `
                <tr>
                    <td>
                        🎬 <a href="${link}" title="Read more about ${title}" aria-label="Read more about ${title}" target="_blank">
                            ${title}
                        </a>
                    </td>
                    <td style="text-align:center;">
                        <a href="${link}" title="${actionText} for ${title}" aria-label="${actionText} for ${title}" class="view-btn" target="_blank">
                            ${actionText}
                        </a>
                    </td>
                </tr>
