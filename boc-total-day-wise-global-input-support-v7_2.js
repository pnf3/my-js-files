...
return "Blockbuster 🚀";
 ...
 window.addEventListener("DOMContentLoaded", function() {
        var movieData = window.dayValues["Rekhachithram Box Office Collection: Day-Wise"];
        ...
        if (movieData) {
            ...
            document.getElementById("profit-loss-2").textContent = profitLoss.toFixed(2);
