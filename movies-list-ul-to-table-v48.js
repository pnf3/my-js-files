document.addEventListener("DOMContentLoaded", () => {
  ...
  function generateDynamicCard(actorName, yearRange) {
    return `<div class="card"><p class="mb-0">Explore the complete, year-wise list of ${actorName}'s movies (${yearRange}) & tv shows — from the debut film to the latest release. This comprehensive filmography includes all movie titles in chronological order, with release years, a running count, hits & flops, box office collection, OTT Release, and the total number of films to date.</p></div>
