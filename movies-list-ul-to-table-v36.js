document.addEventListener("DOMContentLoaded", () => {
  ...
  function generateDynamicCard(actorName, yearRange) {
    return `
	<h2 id="movies-list-title">Complete List of <span id="actor-name-1">${actorName}</span> Movies by Year (${yearRange})</h2>
      <div class="card">
 ...
 // } 
  ...
  function generateDynamicCard(actorName, yearRange) {
    return `
	<h2 id="tv-shows-list-title">Full List of <span id="actor-name-1">${actorName}</span> TV Shows by Year (${yearRange})</h2>
      <div class="card">
