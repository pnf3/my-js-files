...
document.addEventListener("DOMContentLoaded", function () {
    function convertRelatedPostsToTable() {
        ...
        // Create the table structure with an SEO-friendly heading
        let tableHTML = `
        ...
        relatedItems.forEach((item) => {
            ...
            tableHTML += `
                <tr>
                    <td>
                        <a href="${link}" title="Read full box office report for ${title}" aria-label="Read full box office collection report for ${title}" target="_blank">
                            ${title}
                        </a>
                    </td>
                    <td style="text-align:center;">
                        <a href="${link}" title="View detailed earnings for ${title}" aria-label="View detailed earnings for ${title}" class="view-btn" target="_blank">
                            📊 View Report
                        </a>
                    </td>
                </tr>
