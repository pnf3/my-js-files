document.addEventListener("DOMContentLoaded", () => {
  ...
  function generateDynamicCard(actorName, yearRange) {
    return `
	<h2 id="movies-list-title"><span id="actor-name-1">${actorName}</span> Movies List Year-Wise</h2>
      <div class="card">
 ...
 // } 
  ...
  function generateDynamicCard(actorName, yearRange) {
    return `
	<h2 id="tv-shows-list-title"><span id="actor-name-1">${actorName}</span> TV Shows List Year-Wise</h2>
      <div class="card">
