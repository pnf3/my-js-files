      ...
      return `
        <div class="card">
          <p style="margin-bottom:0">
            <p>Explore the complete year-wise <span id="actor-name-1">${actorName}</span> Filmography, from his debut to the latest and upcoming releases. This detailed table includes all <span id="actor-name-2">${actorName}</span> movies list, with movie numbers, release years, titles, and the total film count to date.</p>
          </p>
        </div>`;
    }
